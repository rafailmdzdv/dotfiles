...
(autothemer-deftheme
 ...
 (
  ...
  (tab-bar (:inherit 'variable-pitch :background base :foreground rose))
  (tab-bar-tab (:inherit 'tab-bar :background surface :underline rose))
  (tab-bar-tab-inactive (:inherit 'tab-bar-tab :background base :underline love))
